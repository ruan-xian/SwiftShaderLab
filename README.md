...
- Solid, checkerboard, and selectable image backgrounds. Image assets appear in a thumbnail grid and are registered in `BackgroundImageAsset`. Checkerboard and image placement support click-drag panning, trackpad pinch, keyboard nudging, and inspector scaling.
